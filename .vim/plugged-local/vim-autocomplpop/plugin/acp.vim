...
function s:makeDefaultBehavior()
 ...
 for key in keys(behavs)
  ...
  call add(behavs.pug, {
        \   'command' : "\<C-x>\<C-o>",
        \   'meets'   : 'acp#meetsForPugOmni',
        \   'onPopupClose' : 'acp#pugComplete',
        \   'repeat'  : 1,
        \ })
  "---------------------------------------------------------------------------
  call add(behavs.css, {
  ...
  call add(behavs.javascript, {
        \   'command' : "\<C-x>\<C-o>",
        \   'completefunc' : 'jsomni#complete',
        \   'meets'   : 'acp#meetsForJavaScriptOmni',
        \   'onPopupClose' : 'acp#JsComplete',
        \   'repeat'  : 1,
  \})
  call add(behavs.javascript, {
        \   'command' : "\<C-x>\<C-u>",
        \   'completefunc' : 'jquerycomplete#CompleteSelector',
        \   'meets'   : 'acp#meetsForJavaScriptKeywords',
        \   'onPopupClose' : 'acp#JsComplete',
        \   'repeat'  : 1,
  \})
  "---------------------------------------------------------------------------
  call add(behavs.json, {
        \   'command' : "\<C-x>\<C-o>",
        \   'meets'   : 'acp#meetsForJsonOmni',
        \   'onPopupClose' : 'acp#jsonComplete',
        \   'repeat'  : 1,
        \ })
  "---------------------------------------------------------------------------
